...
test('portal keeps a clean feature-oriented architecture taxonomy', async () => {
  const expectedFiles = [
    ...
    'features/delivery-control-room/DeliveryControlRoom.vue',
    'features/delivery-control-room/useDeliveryControlRoomState.ts',
    'features/delivery-control-room/delivery-control-room-state.ts',
    'features/evidence-ledger/EvidenceLedger.vue',
    'features/evidence-ledger/useEvidenceLedgerState.ts',
    'features/evidence-ledger/evidence-ledger-state.ts',
    ...
    'features/assessment-center/AssessmentCenter.vue',
    'features/assessment-center/useAssessmentCenterState.ts',
    'features/assessment-center/assessment-levels.ts',
    'features/assessment-center/assessment-center-state.ts',
